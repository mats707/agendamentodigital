...
<nav class="navbar navbar-expand navbar-dark main-header">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="${site}/Cliente/Home" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="${site}/Cliente/MinhaConta" class="nav-link">Minha Conta</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="${site}/Cliente/Home" class="brand-link">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="${site}/Cliente/MinhaConta" class="d-block">${cliente.nome}</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="${site}/Cliente/Home" id="home" class="nav-link">
