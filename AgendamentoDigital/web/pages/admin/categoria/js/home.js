...
//                    cadastrarCategorias();
    ...
    function carregarCategoriaServico() {
        $.ajax({
            url: 'api/CategoriaServico/Listar/', //lugar onde a servlet estÃ¡
            type: "GET",
                ...
                if (qtdFilhas > 0) { //cria div da categoria pai que possui filhas
                    ...
                    <div id="divCategoria-' + idCategoria + '" class="card card-primary">                                                                                         \n\
                        <div class="card-header">                                                                                                                                 \n\
                            ...
                            <div class="card-tools">                                                                                                                              \n\
                                <a id="alterar-categoria-' + idCategoria + '" class="btn btn-info btn-sm" href="#sectionAlterarCategoria" onclick="alterarCategoria(this);">                                                                                                          \n\
                                    <i class="fas fa-pencil-alt">                                                                                                                 \n\
                                    </i>                                                                                                                                          \n\
                                    Alterar                                                                                                                                          \n\
                                </a>                                                                                                                                              \n\
                                <a id="deletar-categoria-' + idCategoria + '" class="btn btn-danger btn-sm" href="#sectionAlterarCategoria" onclick="deletarCategoria(this);" data-toggle="modal" data-target="#deleteCategoriaModal">                                                                                                        \n\
                    ...
                    <div id="divCategoria-' + idCategoria + '" class="card card-light">                                                                                         \n\
                        <div class="card-header">                                                                                                                                 \n\
                            ...
                            <div class="card-tools">                                                                                                                              \n\
                                <a id="alterar-categoria-' + idCategoria + '" class="btn btn-info btn-sm" href="#sectionAlterarCategoria" style="color: white" onclick="alterarCategoria(this);">                                                                                                          \n\
                                    <i class="fas fa-pencil-alt">                                                                                                                 \n\
                                    </i>                                                                                                                                          \n\
                                    Alterar                                                                                                                                          \n\
                                </a>                                                                                                                                              \n\
                                <a id="deletar-categoria-' + idCategoria + '" class="btn btn-danger btn-sm" href="#sectionAlterarCategoria" style="color: white" onclick="deletarCategoria(this);" data-toggle="modal" data-target="#deleteCategoriaModal">                                                                                                        \n\
                                    <i class="fas fa-trash">                                                                                                                      \n\
                                    </i>                                                                                                                                          \n\
                                    Delete                                                                                                                                        \n\
                                </a>                                                                                                                                              \n\
