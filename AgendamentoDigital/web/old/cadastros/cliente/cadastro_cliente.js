$(document).ready(function () {
    ...
    function campoemail() {
        ...
        $.ajax({
            url: nameproject + '/api/TipoContato/BuscarNome/Email', //lugar onde a servlet está
            type: 'GET',
    ...
    function enchetipodocumento() {
        //fazer a chamado da servlet
        $.ajax({
            url: nameproject + '/api/TipoDocumento/Listar', //lugar onde a servlet está
            type: 'GET',
            complete: function (e, xhr, result) {
                if (e.readyState == 4 && e.status == 200) {
                    try { //Converte a resposta HTTP JSON em um objeto JavaScript
    ...
    function enchetipocontato() {
        //fazer a chamado da servlet
        $.ajax({
            url: nameproject + '/api/TipoContato/Listar', //lugar onde a servlet está
            type: 'GET',
            complete: function (e, xhr, result) {
                if (e.readyState == 4 && e.status == 200) {
                    try { //Converte a resposta HTTP JSON em um objeto JavaScript
    ...
    function encheestadocivil() {
        //fazer a chamado da servlet
        $.ajax({
            url: nameproject + '/api/EstadoCivil/Listar', //lugar onde a servlet está
            type: 'GET',
            complete: function (e, xhr, result) {
                if (e.readyState == 4 && e.status == 200) {
                    try { //Converte a resposta HTTP JSON em um objeto JavaScript
    ...
    function encheescolaridade() {
        //fazer a chamado da servlet
        $.ajax({
            url: nameproject + '/api/Escolaridade/Listar', //lugar onde a servlet está
            type: 'GET',
            complete: function (e, xhr, result) {
                if (e.readyState == 4 && e.status == 200) {
                    try { //Converte a resposta HTTP JSON em um objeto JavaScript
    ...
    $("#inputBuscarProfissao").autocomplete({
        ...
        source: function (request, response) {
            $.ajax({
                url: nameproject + '/api/Profissao/BuscarNome/' + $("#inputBuscarProfissao").val(), //lugar onde a servlet está
                dataType: "json",
    ...
    function carregarDados() {
        ...
        if (dados !== "" && dados.length >= 2) {
            $.ajax({
                url: nameproject + '/api/Profissao/BuscarId/' + dados, //lugar onde a servlet está
                dataType: "json",
                success: function (data) {
...
//     Função para limpar os campos caso a busca esteja vazia
    ...
    $("select#cmbtipodocumento").change(function () {
        ...
        if (i == 0) {
            ...
            //fazer a chamado da servlet
            $.ajax({
                url: nameproject + '/api/TipoDocumento/Buscar/' + i, //lugar onde a servlet está
                type: 'GET',
                complete: function (e, xhr, result) {
                    if (e.readyState == 4 && e.status == 200) {
                        try { //Converte a resposta HTTP JSON em um objeto JavaScript
    ...
    $("select#cmbtipocontato").change(function () {
        ...
        if (i == 0) {
            ...
            //fazer a chamado da servlet
            $.ajax({
                url: nameproject + '/api/TipoContato/Buscar/' + i, //lugar onde a servlet está
                type: 'GET',
                complete: function (e, xhr, result) {
                    if (e.readyState == 4 && e.status == 200) {
                        try { //Converte a resposta HTTP JSON em um objeto JavaScript
    ...
    $('#verificaUsuario').click(function () {
        ...
        $.ajax({
            url: nameproject + '/api/Usuario/BuscarNome/' + username, //lugar onde a servlet está
            type: "GET",
            complete: function (e, xhr, result) {
                if (e.readyState == 4 && e.status == 200) {
                    try { //Converte a resposta HTTP JSON em um objeto JavaScript
