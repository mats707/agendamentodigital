...
<html lang="pt-br">
    <head>        
        ...
        <!--===============================================================================================-->
        <link rel="stylesheet" type="text/css" href="${site}/fonts/iconic/css/material-design-iconic-font.min.css">
        <!--===============================================================================================-->
        ...
        <!--===============================================================================================-->
        <link href="${site}/estilos/util.css" rel="stylesheet" type="text/css"/>
        <link href="${site}/estilos/estiloLogin.css" rel="stylesheet" type="text/css"/>
        <!--===============================================================================================-->
    </head>
    <body>	
        <div class="limiter">
            <div class="container-login100 image-bg">                     
                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    <form class="login100-form validate-form" method="POST" id="formRegister" name="formRegister" action="/AgendamentoDigital/CadastrarUsuario">
                        ...
                        <div class="container-login100-form-btn" id="btnvoltar">
                            <div class="wrap-login100-form-btn">
                                ...
                                <a class="login100-form-btn btn btn-block" href="${site}/paginas/principal.jsp">
